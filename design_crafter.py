...
"}"))
        ...
        self.cam_tab = QtGui.QWidget()
        self.cam_tab.setObjectName(_fromUtf8("cam_tab"))
        self.gridLayout_3 = QtGui.QGridLayout(self.cam_tab)
        self.gridLayout_3.setObjectName(_fromUtf8("gridLayout_3"))
        self.victim_ip_label = QtGui.QLabel(self.cam_tab)
        self.victim_ip_label.setObjectName(_fromUtf8("victim_ip_label"))
        self.gridLayout_3.addWidget(self.victim_ip_label, 0, 0, 1, 1)
        self.victim_ip_box = QtGui.QLineEdit(self.cam_tab)
        self.victim_ip_box.setObjectName(_fromUtf8("victim_ip_box"))
        self.gridLayout_3.addWidget(self.victim_ip_box, 1, 0, 1, 2)
        ...
        self.cam_text_browser = QtGui.QTextBrowser(self.cam_tab)
        self.cam_text_browser.setObjectName(_fromUtf8("cam_text_browser"))
        self.gridLayout_3.addWidget(self.cam_text_browser, 2, 0, 1, 4)
        spacerItem3 = QtGui.QSpacerItem(102, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem3, 3, 0, 1, 1)
        self.stop_cam_button = QtGui.QPushButton(self.cam_tab)
        self.stop_cam_button.setObjectName(_fromUtf8("stop_cam_button"))
        self.gridLayout_3.addWidget(self.stop_cam_button, 3, 1, 1, 2)
        self.start_cam_button = QtGui.QPushButton(self.cam_tab)
        self.start_cam_button.setObjectName(_fromUtf8("start_cam_button"))
        self.gridLayout_3.addWidget(self.start_cam_button, 3, 3, 1, 1)
        self.tabWidget.addTab(self.cam_tab, _fromUtf8(""))
        ...
        self.victim_ip_label.setBuddy(self.victim_ip_box)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.victim_ip_label.setText(_translate("MainWindow", "Victim\'s IP:", None))
        self.stop_cam_button.setText(_translate("MainWindow", "Stop", None))
        self.start_cam_button.setText(_translate("MainWindow", "Start", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.cam_tab), _translate("MainWindow", "CAM", None))
        self.tabWidget.setTabToolTip(self.tabWidget.indexOf(self.cam_tab), _translate("MainWindow", "CAM Flooder", None))
